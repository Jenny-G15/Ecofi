export async function getFormulario() {
    try {
        ...
        const response = await fetch('http://192.168.8.105:3000/formularios', {  //http://192.168.1.246  //http://192.168.100.121
            method: 'GET',
            headers: {
...
export async function agregarFormulario(data) {
    try {
        const response = await fetch('http://192.168.8.105:3000/formularios', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export async function actualizaFormulario(id, data) {
    try {
        const response = await fetch(`http://192.168.8.105:3000/formularios/${id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
